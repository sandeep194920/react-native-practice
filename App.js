...
export default function App() {
  ...
  const tasks = [
    ...
    { id: 'day1-task4', title: 'Task 4: Shopping Cart', component: Task4_ShoppingCart, day: 'Day 1', time: '20-25 min' },
    { id: 'day1-task5', title: 'Task 5: Data Transformation', component: Task5_DataTransformation, day: 'Day 1', time: '20-25 min' },
    { id: 'day2-task6', title: 'Task 6: Pull to Refresh', component: Task6_PullToRefresh, day: 'Day 2', time: '20-30 min' },
    { id: 'day2-task7', title: 'Task 7: Infinite Scroll', component: Task7_InfiniteScroll, day: 'Day 2', time: '30-45 min' },
    { id: 'day2-task8', title: 'Task 8: Form Validation', component: Task8_FormValidation, day: 'Day 2', time: '30-45 min' },
  ];
    ...
    return (
      <SafeAreaView style={styles.taskContainer}>
        <View style={styles.taskHeader}>
          <TouchableOpacity onPress={() => setCurrentTask(null)} style={styles.backButton}>
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>TopTal Technical Interview Practice</Text>
        <Text style={styles.interviewDate}>Interview: Mon, Feb 02, 2026 @ 11:30 AM EST</Text>
      </View>

      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        {/* Day 1 Section */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>📅 Day 1 - Core Patterns (5 hours)</Text>
          <Text style={styles.sectionDescription}>Master the most common RN interview tasks</Text>
          {tasks.filter(task => task.day === 'Day 1').map((task) => (
            <TouchableOpacity
              key={task.id}
        ...
        {/* Day 2 Section */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>📅 Day 2 - Advanced Patterns (4 hours)</Text>
          <Text style={styles.sectionDescription}>Handle complex scenarios</Text>
          {tasks.filter(task => task.day === 'Day 2').map((task) => (
            <TouchableOpacity
              key={task.id}
              style={styles.taskButton}
              onPress={() => setCurrentTask(task)}
        ...
        {/* Day 3 Section */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>📅 Day 3 - Mock Interviews (3 hours)</Text>
          <Text style={styles.sectionDescription}>Full interview simulations</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.tipBox}>
            <Text style={styles.tipText}>✅ Always use keyExtractor on FlatList</Text>
            <Text style={styles.tipText}>✅ Handle loading, error, empty states</Text>
            <Text style={styles.tipText}>✅ Use Set for O(n) deduplication</Text>
            <Text style={styles.tipText}>✅ useEffect cleanup prevents memory leaks</Text>
            <Text style={styles.tipText}>✅ Talk out loud during practice!</Text>
          </View>
        </View>
